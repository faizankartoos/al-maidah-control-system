...
def get_dashboard_report(from_date, to_date):
    ...
    return {
        ...
        "summary": {
            ...
            "food_cost_ratio": profit["summary"]["food_cost_ratio"],
            "labour_cost_ratio": profit["summary"]["labour_cost_ratio"],
            "marketing_expense_ratio": profit["summary"]["marketing_expense_ratio"],
